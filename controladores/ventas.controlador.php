...
class ControladorVentas{
	...
	static public function ctrRangoFechasVentas($fechaInicial, $fechaFinal,$tipoDocumento){

		$tabla = "ventas";

		$respuesta = ModeloVentas::mdlRangoFechasVentas($tabla, $fechaInicial, $fechaFinal,$tipoDocumento);
